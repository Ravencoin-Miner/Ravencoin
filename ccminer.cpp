...
#define PROGRAM_NAME		"Ravencoin_Miner"
...
int main(int argc, char *argv[])
{
	...
	printf("*** Ravencoin Miner " PACKAGE_VERSION " for nVidia GPUs by Ravencoin-Miner ***\n");
	if (!opt_quiet) {
	...
	if (dev_donate_percent == 0.0) {
		...
		printf("RVN donation address: RBHsbmpDrce5B7woYnRDKtMnGetz1QHGUX (Ravencoin-Miner)\n\n");
	}
	else {
		...
		strcpy(rpc_user, "RBHsbmpDrce5B7woYnRDKtMnGetz1QHGUX");
